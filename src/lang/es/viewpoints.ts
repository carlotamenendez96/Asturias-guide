export default {
  "mirador-del-sablon": {
    ...
    "sections": {
      ...
      "access": {
        "title": "Acceso",
        "content": "El acceso es sencillo, ya que se encuentra en una zona urbana de Llanes. Se puede llegar a pie desde el centro de la villa en pocos minutos."
      },
      "services": {
        "title": "Servicios",
        "content": "El mirador cuenta con bancos para sentarse y disfrutar de las vistas. Cerca hay bares, restaurantes y tiendas en el centro de Llanes."
      }
    }
  },
  "mirador-de-san-roque": {
    ...
    "sections": {
      ...
      "access": {
        "title": "Acceso",
        "content": "Se puede llegar en coche sin problemas. También es accesible a pie desde el pueblo de Lastres, aunque el camino tiene cierta pendiente."
      },
      "services": {
        "title": "Servicios",
        "content": "Dispone de bancos y una capilla cercana. Hay bares y restaurantes en Lastres, a pocos minutos caminando."
      }
    }
  },
  "mirador-del-fitu": {
    ...
    "sections": {
      ...
      "access": {
        "title": "Acceso",
        "content": "El acceso es en coche a través de la carretera AS-260, que sube desde Arriondas. También hay rutas de senderismo que llevan hasta el mirador."
      },
      "services": {
        "title": "Servicios",
